      ...
      <main className="home-main">
        ...
        <section id="home-header" className="home-header-section">
          <header className="home-header-content">
            <h1>Bem-vindo ao <br />Software Café</h1>
            <p>
              Descubra os melhores cafés, suas origens, métodos de <br />preparo e dicas para apreciar cada xícara ao máximo.
            </p>
          </header>
        </section>
        ...
        <section id="home-featured" className="home-featured-section">
          <header className="home-featured-header">
            <div className="home-featured-container">
              ...
              <p>
                Experimente nossos cafés selecionados, perfeitos para todos os gostos e momentos.
              </p>
            </div>
          </header>
          <div className="home-featured-content">
            <div className="home-featured-cards">
              {featuredCoffees.map((coffee) => (
                <div className="home-featured-card" key={coffee.title}>
                  <section className="home-featured-card-content">
                    <span className="home-featured-icon">
                      <img src={coffee.img} alt={coffee.alt} className="home-featured-img" />
                    </span>
                    <header>
                      <h3>{coffee.title}</h3>
                    </header>
            ...
            <div className="home-featured-footer">
              <div>
                <a href="/loja" className="button home-featured-button">
                  Veja mais cafés
                </a>
              </div>
            </div>
        ...
        {/* Dicas e Delivery */}
        <section id="home-tips-delivery" className="home-tips-delivery-section">
          <header className="home-tips-delivery-header">
            <div className="home-tips-delivery-container">
              <h2>Dicas e Entrega</h2>
            </div>
          </header>
          <div className="home-tips-delivery-content" style={{ display: "flex", justifyContent: "center", alignItems: "center", flexDirection: "row", gap: "2em", textAlign: "center" }}>
            <div className="home-tips">
              <section className="home-tips-content">
                ...
                <ul>
                  ...
                  <li>Use água filtrada e na temperatura ideal (92°C a 96°C).</li>
                  <li>Experimente diferentes métodos de preparo.</li>
                </ul>
                <img src={CoffeeImg} alt="Grãos de Café" className="home-tips-img" />
              </section>
            </div>
            <div className="home-delivery">
              <div className="home-delivery-images">
                <img src={cafeDeliveryImg} alt="Entrega de Café" className="home-delivery-img" />
              </div>
              <section className="home-delivery-content">
                ...
                <a href="/entrega" className="button home-delivery-button">
                  Café Para Entrega
                </a>
              </section>
            </div>
        ...
        <section id="home-menu" className="home-menu-section">
          <header className="home-menu-header">
            <div className="home-menu-container">
              <h2>Menu</h2>
              <p>
                Explore todas as áreas do nosso site e descubra tudo sobre cafés, franquias, dicas e muito mais.
              </p>
            </div>
          </header>
            ...
            <div className="home-menu-row">
              <div className="home-menu-list">
                <ul>
                  <li>
                    <a href="/loja">
                      <FontAwesomeIcon icon={faCartShopping} className="home-menu-icon" />
                      Loja
                    </a>
                  </li>
                  <li>
                    <a href="/sobre-nos">
                      <FontAwesomeIcon icon={faBuilding} className="home-menu-icon" />
                      Sobre Nós
                    </a>
                  </li>
                  <li>
                    <a href="/tutorial">
                      <FontAwesomeIcon icon={faMugSaucer} className="home-menu-icon" />
                      Faça Você Mesmo
                    </a>
                  </li>
                  <li>
                    <a href="/franqueado">
                      <FontAwesomeIcon icon={faShop} className="home-menu-icon" />
                      Franquia
                    </a>
                  </li>
                  <li>
                    <a href="/contato">
                      <FontAwesomeIcon icon={faWhatsapp} className="home-menu-icon" />
                      Contato
                    </a>
                  </li>
                </ul>
              ...
              <div className="home-menu-image">
                <img src={CafeEGraos} alt="Banner Café" className="home-menu-banner-img" />
              </div>
            </div>
          </div>
        </section>
        ...
        <section id="home-footer" className="home-footer-section">
          <ul className="home-footer-icons">
            ...
            <li>
              <a href="#" className="icon brands fa-whatsapp">
